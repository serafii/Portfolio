  ...
  return (
    <section className="w-full px-6 py-4 sm:px-10">
      <motion.div
        ...
        className="mx-auto grid w-full max-w-6xl items-center gap-10 rounded-[2.25rem] border border-indigo-200/70 bg-slate-100 p-7 shadow-xl shadow-indigo-950/5 transition-colors duration-300 hover:border-violet-400/70 dark:border-violet-300/15 dark:bg-[#160c23] dark:shadow-black/25 dark:hover:border-violet-300/45 md:grid-cols-[minmax(12rem,0.65fr)_minmax(0,1.35fr)] md:gap-12 md:rounded-[3rem] md:p-12"
      >
